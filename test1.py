...
for evt in cache_evt_file:
    cmd = "perf stat --post /mnt/B/sem3/mss/project/post.sh -e {} -o /mnt/B/sem3/mss/project/temp.log -I {} --interval-count {}".format(evt.lstrip().rstrip(), sampling_interval, interval_count)
